...
//            x      y      z       r     g     b
    ...
    vbo = std::shared_ptr<VertexBuffer>::make_shared(*new VertexBuffer(cube_data, sizeof(cube_data)));
    ...
    ibo = std::shared_ptr<IndexBuffer>::make_shared(*new IndexBuffer(cube_indices, sizeof(cube_indices)));
}
